...
namespace Massive.PervasiveSql {
    ...
    public class DynamicModel : DynamicObject {
        ...
        public DynamicModel(string connectionStringName, string tableName = "",
            ...
            var _providerName = "Pervasive.Data.SqlClient";
        ...
        */
        ...
        public virtual dynamic Single(object key, string columns = "*") {
            var sql = string.Format("SELECT {0} FROM {1} WHERE {2} = ?", columns, TableName, PrimaryKeyField);            
        ...
        public virtual DbCommand CreateUpdateCommand(dynamic expando, object key) {
            ...
            if (counter > 0) {
                ...
                result.CommandText = string.Format(stub, TableName, keys, PrimaryKeyField);                
        ...
        public virtual DbCommand CreateDeleteCommand(string where = "", object key = null, params object[] args) {
            ...
            if (key != null) {
                sql += string.Format("WHERE {0}=?", PrimaryKeyField);               
                args = new object[] { key };
                ...
                for (int i = 0; i < args.Length; i++) {
                    ...
                    switch (name) {
                        ...
                        case "columns":
                            ...
                            break;
                        default:
                            constraints.Add(string.Format(" {0} = ?", name));                            
